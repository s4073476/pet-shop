...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
				<label for="sub_category_id" class="control-label">Breed</label>
                <select name="sub_category_id" id="sub_category_id" class="custom-select" required>
                <option value="" selected="" disabled="">Select Breed First</option>
                <?php
			...
			<div class="form-group">
				<label for="product_name" class="control-label">Pet Name</label>
